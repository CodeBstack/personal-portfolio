...
> = () => {
  ...
  return (
    <div
      className={`${
        navBg && 'shadow-boxShadow'
      } z-[100]  sticky top-0 transition-all duration-300 ease-linear py-9 flex items-center justify-between font-SF1 text-nav-text text-[13px]`}
    >
      <Logo />
